...
# (str) Package name
package.name = RoseVines

# (str) Package domain (needed for android/ios packaging)
package.domain = org.rose
...
requirements = python3, kivy==2.3.0, https://files.pythonhosted.org/packages/20/81/0b1154f5e581d5910702d9fadb3217f56cb186f72c8b36de0271e7ff9b5c/kivymd-1.2.0.tar.gz, zeroconf
p4a.branch = develop
